...
PRUEBAS.caso('⚠️ los tres accesos están JUNTO al botón, no sueltos', () => {
  ...
  const m = PRUEBAS.enVentana(390, 844, () => {
    ...
    /* ⚠️ La lista rotulada de P095 se revirtió el 2026-09-06: Franco la rechazó mirándola y
       volvieron los dos accesos directos. Se mide el PRIMERO de ellos, que es lo primero que se ve
       debajo del botón. Ver la cabecera de `p095-portada-lista.js`. */
  ...
  /* Vuelve al tope original: con los dos accesos EN LÍNEA separados por un punto, el hueco
     vertical entre ellos es 0 salvo que envuelvan. */
